...
public abstract class AsyncMemoryWriteService extends
	 ...
	 * @return
	 */
	public abstract <V> void save(String key, V value,
	 ...
	 * @return
	 */
	public abstract <V> void save(String key, V value, TimeUnit tu, int time,
			Callback<Boolean> callback);
	 ...
	 * @return
	 */
	public abstract void remove(String key, Callback<Boolean> callback);
	 ...
	 * @return
	 */
	public abstract <V> void save(int key, V value, Callback<Boolean> callback);
	 ...
	 * @return
	 */
	public abstract <V> void save(int key, V value, TimeUnit tu, int time,
			Callback<Boolean> callback);
	 ...
	 * @return
	 */
	public abstract void remove(int key, Callback<Boolean> callback);
	 ...
	 * @return
	 */
	public abstract void clear(Callback<Boolean> callback);
